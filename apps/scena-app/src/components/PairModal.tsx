...
import { Button, cn, Dialog, DialogContent, Input, Switch } from "@4dl/ui";
...
export function PairModal({ open, onClose, onPaired }: { open: boolean; onClose: () => void; onPaired: (result?: ClaimResult) => void }) {
