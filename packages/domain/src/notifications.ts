...
export const NOTIF_CATEGORIES: NotifCategoryMeta[] = [
  ...
  { key: "billing", label: "Studio billing", blurb: "Your Kova subscription, credits and setup", roles: ["owner"] },
...
export const NOTIF_TYPES: Record<NotifType, NotifTypeMeta> = {
  ...
  billing_suspended: { category: "billing", to: "owner", title: "Your studio is suspended", link: "/business",
    template: { subject: "Your studio is suspended", body: "<p>Your Kova subscription lapsed, so paid features are paused for you and your clients. Update your payment method to restore everything instantly.</p>" }, vars: [] },
  billing_canceled: { category: "billing", to: "owner", title: "Subscription canceled", link: "/business",
    template: { subject: "Your subscription was canceled", body: "<p>Your Kova subscription was canceled and your studio is on the free plan. Resubscribe anytime to bring back paid features for you and your clients.</p>" }, vars: [] },
  billing_trial_ending: { category: "billing", to: "owner", title: "Your free trial ends soon", link: "/business",
    template: { subject: "Your Kova trial ends in {{daysLeft}} days", body: "<p>Your free trial of the {{planName}} plan ends in {{daysLeft}} days, and your card will be charged then. Nothing to do if you're happy — change or cancel your plan any time from Business.</p>" }, vars: ["planName", "daysLeft"] },
  billing_past_due: { category: "billing", to: "owner", title: "Payment failed", link: "/business",
    template: { subject: "Payment failed — action needed", body: "<p>We couldn't charge your card for your Kova subscription. Update your payment method to keep your studio running — you have a short grace period before features pause.</p>" }, vars: [] },
