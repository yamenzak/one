  ...
  notifications: {
    ...
    */
    "workspace.created": {
      ...
      title: "{slug} is ready",
      link: { to: "inbox" },
      roles: ["owner"], needs: "member:manage",
    },
    "plan.chosen": {
    ...
    */
    "milestone.earned": {
      ...
      title: "{title}",
      link: { to: "inbox" },
      roles: ["owner", "trainer"], needs: "client:read",
    },
  },
