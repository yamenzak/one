...
role: [owner, trainer]
summary: >
  Your library is the list of movements you can put in a plan. Add your own,
  bind alternatives a client can swap to on their own, and archive what you no
  longer coach.
keywords: [exercise, library, movement, alternatives, swap, archive, filter, search]
updated: 2026-08-04
---
...
![The Exercises tab: a search field, a filter button, a list/grid toggle and an add button above a list of movements.](images/coach-library.png)
