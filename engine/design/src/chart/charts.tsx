...
export const CHART_MOTION = [
  `@keyframes one-draw { from { opacity: 0; transform: translateY(4px) } to { opacity: 1; transform: none } }`,
  `[data-draw="true"] { animation: one-draw var(--default-transition-duration) var(--ease-out-fluid) both; transform-origin: bottom; }`,
