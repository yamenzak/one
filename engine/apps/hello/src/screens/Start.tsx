 ...
 * `milestones` and `help` were in hello's manifest from the first stage; the
    ...
    <Screen shape="board" title={title}>
      <Stack space="roomy">
        ...
        <Section label="Your first three things">
          <Guide book={HELLO.guide ?? {}} events={done} held={held} onGo={onGo} />
        </Section>

        <Section label="What you have reached">
          <Milestones book={HELLO.milestones ?? {}} counts={counts} already={[]} />
        </Section>
        ...
        <Grid min="20rem" space="roomy">
          <Section label="About this screen">
            ...
            <Help book={HELLO.help ?? {}} screen="notes" />
          </Section>
