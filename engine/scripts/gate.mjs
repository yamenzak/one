...
const GUARDS = [
  ...
  "operator", "jobs", "ledger-chokepoint", "item-life", "ai-commits", "release-ladder", "job-tells", "label-once", "ai-action", "vault", "workspace", "edit", "problem", "descend", "settings", "rules", "bundle", "capability", "routed", "dossier", "infra", "logs",
];
