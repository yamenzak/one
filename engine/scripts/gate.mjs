...
const GUARDS = [
  ...
  "heroui", "chrome", "ground", "motion", "metrics", "rhythm", "travel", "cards", "glyphs", "attrs", "showcase", "states", "shape", "face", "scene", "spoken",
  "gates",
  "present", "keys",
  "provenance", "surface", "space", "doors", "services", "agent", "access", "package", "reached",
  "operator", "jobs", "ledger-chokepoint", "reach", "item-life", "ai-commits", "release-ladder", "job-tells", "label-once", "inferred-consumption", "one-planner", "input-checked", "packing", "settled", "lanes", "switchable", "screen-index", "ai-action", "vault", "workspace", "edit", "problem", "descend", "settings", "rules", "bundle", "capability", "routed", "dossier", "infra", "logs", "asking", "renewal", "weight", "keeping", "placed", "copied", "d1", "shipping", "awaited", "moving", "reading", "hand",
];
