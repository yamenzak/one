...
const GUARDS = [
  ...
  "operator", "jobs", "ledger-chokepoint", "reach", "item-life", "ai-commits", "release-ladder", "job-tells", "label-once", "inferred-consumption", "one-planner", "input-checked", "screen-index", "ai-action", "vault", "workspace", "edit", "problem", "descend", "settings", "rules", "bundle", "capability", "routed", "dossier", "infra", "logs", "asking", "renewal", "weight", "keeping",
];
