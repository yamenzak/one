...
const GUARDS = [
  ...
  "gates",
  "present", "keys",
  "provenance", "surface", "space", "doors", "services", "agent", "access", "package", "reached", "shadow", "borrowed",
  "operator", "jobs", "ledger-chokepoint", "reach", "item-life", "ai-commits", "release-ladder", "job-tells", "label-once", "inferred-consumption", "one-planner", "input-checked", "packing", "currency", "money", "settled", "story", "screen-index", "ai-action", "vault", "workspace", "edit", "problem", "descend", "settings", "rules", "bundle", "capability", "routed", "dossier", "infra", "logs", "asking", "renewal", "weight", "keeping", "placed", "drawn", "rendered", "copied", "d1", "shipping", "awaited", "moving", "reading", "hand",
];
