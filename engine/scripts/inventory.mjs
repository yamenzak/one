...
if (what === "guards") {
  ...
  const KERNEL = [
    ...
    ["document", "what a thing somebody COMMITS to is: the ladder, the series, the reversal"],
  ...
  const RUNTIME = [
    ...
    ["google", "the models Cloudflare does not host, and what Google publishes them at"],
