...
const MCP = readFileSync(join(QUAD, "runtime/src/mcp.ts"), "utf8");
const SERVE = readFileSync(join(QUAD, "runtime/src/serve.ts"), "utf8");
const MEMBER_OPS = readFileSync(join(QUAD, "runtime/src/member-ops.ts"), "utf8");
const mcp = strip(MCP);
