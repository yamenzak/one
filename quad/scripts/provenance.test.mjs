 ...
 */
const schema = readFileSync(join(QUAD, "runtime/src/schema.ts"), "utf8");
...
const compose = readFileSync(join(QUAD, "runtime/src/compose.ts"), "utf8");
 ...
 * nobody's record.
 */
const records = readFileSync(join(QUAD, "runtime/src/records.ts"), "utf8");
