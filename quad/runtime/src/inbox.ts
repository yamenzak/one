...
import type { Channel, NotificationBook, Policy, Preference, TenantId } from "@quad/kernel";
import { channelsFor, inAudience, newId, permissionsFor } from "@quad/kernel";
import type { RoleRegistry } from "@quad/kernel";
